...
/** Input for the createScout mutation */
...
/** Input for the deleteScout mutation */
export interface DeleteScoutInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the scout to delete */
  id: Scalars["ID"];
}
...
/** Arguments for filtering the RootQueryToScoutConnection connection */
export interface RootQueryToScoutConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Input for the updateScout mutation */
...
export interface UserToAwardConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the UserToScoutConnection connection */
export interface UserToScoutConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const generatedSchema = {
  ...
  Award: {
    ...
    authorId: { __type: "ID" },
    awardId: { __type: "Int!" },
    awardName: { __type: "String" },
    communityName: { __type: "[String]" },
    ...
    preview: { __type: "AwardToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    scoutName: {
      __type: "AwardToScoutConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    slug: { __type: "String" },
    ...
    totalScoutsNeeded: { __type: "Float" },
    uri: { __type: "String" },
  },
  AwardToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Award" },
  },
  AwardToScoutConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[AwardToScoutConnectionEdge]" },
    nodes: { __type: "[Scout]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  AwardToScoutConnectionEdge: {
    __typename: { __type: "String!" },
  ...
  RootQueryToAwardConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToScoutConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToScoutConnectionEdge]" },
    nodes: { __type: "[Scout]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToScoutConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Scout" },
  },
  RootQueryToScoutConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  Scout: {
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    photo: { __type: "MediaItem" },
    preview: { __type: "ScoutToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    scoutId: { __type: "Int!" },
    slug: { __type: "String" },
  ...
  User: {
    ...
    awards: {
      __type: "UserToAwardConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToAwardConnectionWhereArgs",
      },
    },
    ...
    scouts: {
      __type: "UserToScoutConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToScoutConnectionWhereArgs",
      },
    },
    slug: { __type: "String" },
    templates: { __type: "[String]" },
  ...
  UserToAwardConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToAwardConnectionEdge]" },
    nodes: { __type: "[Award]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  UserToAwardConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToScoutConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToScoutConnectionEdge]" },
    nodes: { __type: "[Scout]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToScoutConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Scout" },
  },
  UserToScoutConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    ...
    createScout: {
      __type: "CreateScoutPayload",
      __args: { input: "CreateScoutInput!" },
    },
    createTag: {
    ...
    deleteScout: {
      __type: "DeleteScoutPayload",
      __args: { input: "DeleteScoutInput!" },
    },
    deleteTag: {
    ...
    updateScout: {
      __type: "UpdateScoutPayload",
      __args: { input: "UpdateScoutInput!" },
    },
    updateSettings: {
  ...
  query: {
    ...
    award: {
      __type: "Award",
      __args: { asPreview: "Boolean", id: "ID!", idType: "AwardIdType" },
    },
    awardBy: {
      __type: "Award",
      __args: { awardId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    awards: {
      __type: "RootQueryToAwardConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToAwardConnectionWhereArgs",
      },
    },
    categories: {
    ...
    scout: {
      __type: "Scout",
      __args: { asPreview: "Boolean", id: "ID!", idType: "ScoutIdType" },
    },
    scoutBy: {
      __type: "Scout",
      __args: { id: "ID", scoutId: "Int", slug: "String", uri: "String" },
    },
    scouts: {
      __type: "RootQueryToScoutConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToScoutConnectionWhereArgs",
      },
    },
...
export interface Award {
  ...
  groupImpacted?: Maybe<ScalarsEnums["String"]>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the award object.
   */
  id: ScalarsEnums["ID"];
  /**
  ...
  /**
   * Connection between the award type and the award type
   */
  preview?: Maybe<AwardToPreviewConnectionEdge>;
  /**
  ...
  /**
   * Connection between the award type and the scout type
   */
  scoutName: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
  ...
  totalScoutsNeeded?: Maybe<ScalarsEnums["Float"]>;
  /**
 ...
 * Connection between the award type and the award type
 */
export interface AwardToPreviewConnectionEdge {
  __typename?: "AwardToPreviewConnectionEdge";
  /**
 ...
 * Connection between the award type and the scout type
 */
export interface AwardToScoutConnection {
  __typename?: "AwardToScoutConnection";
  /**
   * Edges for the AwardToScoutConnection connection
   */
  edges?: Maybe<Array<Maybe<AwardToScoutConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Scout>>>;
  /**
 ...
 */
export interface AwardToScoutConnectionEdge {
  __typename?: "AwardToScoutConnectionEdge";
  /**
...
/**
 * The payload for the createScout mutation
 */
export interface CreateScoutPayload {
  __typename?: "CreateScoutPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteAward mutation
 */
export interface DeleteAwardPayload {
...
/**
 * The payload for the deleteScout mutation
 */
export interface DeleteScoutPayload {
  __typename?: "DeleteScoutPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the award type
 */
export interface RootQueryToAwardConnection {
  __typename?: "RootQueryToAwardConnection";
  /**
   * Edges for the RootQueryToAwardConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToAwardConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface RootQueryToAwardConnectionEdge {
...
/**
 * Connection between the RootQuery type and the scout type
 */
export interface RootQueryToScoutConnection {
  __typename?: "RootQueryToScoutConnection";
  /**
   * Edges for the RootQueryToScoutConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToScoutConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Scout>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToScoutConnectionEdge {
  __typename?: "RootQueryToScoutConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Scout {
   ...
   * Grade in school
   */
  grade?: Maybe<ScalarsEnums["Float"]>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the scout object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
  ...
  /**
   * Connection between the scout type and the scout type
   */
  preview?: Maybe<ScoutToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
 ...
 * Connection between the scout type and the scout type
 */
export interface ScoutToPreviewConnectionEdge {
  __typename?: "ScoutToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Scout>;
...
/**
 * The payload for the updateAward mutation
 */
...
/**
 * The payload for the updateScout mutation
 */
export interface UpdateScoutPayload {
  __typename?: "UpdateScoutPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  ...
  /**
   * Connection between the User type and the award type
   */
  awards: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToAwardConnectionWhereArgs>;
  }) => Maybe<UserToAwardConnection>;
  /**
  ...
  /**
   * Connection between the User type and the scout type
   */
  scouts: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToScoutConnectionWhereArgs>;
  }) => Maybe<UserToScoutConnection>;
  /**
 ...
 * Connection between the User type and the award type
 */
export interface UserToAwardConnection {
  __typename?: "UserToAwardConnection";
  /**
   * Edges for the UserToAwardConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToAwardConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Award>>>;
 ...
 * An edge in a connection
 */
export interface UserToAwardConnectionEdge {
  __typename?: "UserToAwardConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the User type and the scout type
 */
export interface UserToScoutConnection {
  __typename?: "UserToScoutConnection";
  /**
   * Edges for the UserToScoutConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToScoutConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Scout>>>;
 ...
 * An edge in a connection
 */
export interface UserToScoutConnectionEdge {
  __typename?: "UserToScoutConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  deleteScout: (args: { input: DeleteScoutInput }) => Maybe<DeleteScoutPayload>;
  ...
  updateScout: (args: { input: UpdateScoutInput }) => Maybe<UpdateScoutPayload>;
  updateSettings: (args: {
...
export interface Query {
  ...
  award: (args: {
    ...
    id: Scalars["ID"];
    idType?: Maybe<AwardIdType>;
  }) => Maybe<Award>;
  awardBy: (args?: {
    awardId?: Maybe<Scalars["Int"]>;
    id?: Maybe<Scalars["ID"]>;
  ...
  awards: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToAwardConnectionWhereArgs>;
  }) => Maybe<RootQueryToAwardConnection>;
  categories: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
  ...
  scout: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<ScoutIdType>;
  }) => Maybe<Scout>;
  scoutBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    scoutId?: Maybe<Scalars["Int"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Scout>;
  scouts: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToScoutConnectionWhereArgs>;
  }) => Maybe<RootQueryToScoutConnection>;
...
export interface SchemaObjectTypes {
  ...
  Avatar: Avatar;
  Award: Award;
  AwardToPreviewConnectionEdge: AwardToPreviewConnectionEdge;
  AwardToScoutConnection: AwardToScoutConnection;
  AwardToScoutConnectionEdge: AwardToScoutConnectionEdge;
  Category: Category;
  ...
  CreateScoutPayload: CreateScoutPayload;
  ...
  DeleteScoutPayload: DeleteScoutPayload;
  ...
  RootQueryToScoutConnection: RootQueryToScoutConnection;
  RootQueryToScoutConnectionEdge: RootQueryToScoutConnectionEdge;
  ...
  UpdateScoutPayload: UpdateScoutPayload;
  ...
  UserToScoutConnection: UserToScoutConnection;
  UserToScoutConnectionEdge: UserToScoutConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ScoutIdType: ScoutIdType | undefined;
